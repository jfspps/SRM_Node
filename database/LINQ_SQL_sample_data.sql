...
insert into grade_thresholds(Highest_raw_threshold, High1_raw, High2_raw, High3_raw, Lowest_raw)
values (23, 20, 18, 15, 13), (30, 28, 26, 24, 20), (65, 60, 55, 50, 45), (65, 60, 55, 50, 45);

insert into letter_grade_chars(Highest_char, High1_char, High2_char, High3_char, Lowest_char)
values ('A', 'B', 'C', 'D', 'E'), ('A', 'B', 'C', 'D', 'E'), ('a', 'b', 'c', 'd', 'e'), ('a', 'b', 'c', 'd', 'e');
...
-- PART 7 -------------------------------------------------------------------------------------------------------------------
insert into grading_groups(assignment_id, grade_thresholds_id, letter_grade_chars_id) values(1, 1, 1), (2, 2, 2), (3, 3, 3), (4, 4, 4);
